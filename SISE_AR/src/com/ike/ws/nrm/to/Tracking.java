...
public class Tracking {
    ...
    public String toString() {
        return "Tracking{" + "latitud=" + latitud + ", longitud=" + longitud + ", ubicacionVehiculo=" + ubicacionVehiculo + ", fechaHoraRegistro=" + fechaHoraRegistro + ", estatusServicio=" + estatusServicio + ", velocidad=" + velocidad + ", estatusArranque=" + estatusArranque + ", nivelBateria=" + nivelBateria + ", kilometraje=" + kilometraje + ", exitoso=" + exitoso + ", message=" + message + '}';
    }
}
