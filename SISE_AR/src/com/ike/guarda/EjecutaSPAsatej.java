...
import com.ike.pdf.CertificadoASATEJ;
 ...
 * @version
 */
public class EjecutaSPAsatej extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //<<<<<<<<<<<<<<<<<  Regresa la ruta para guardar el PDF  >>>>>>>>>>>>>>>>>>
        if (sessionH.getAttribute("Path") != null) {
            StrPathPDF = sessionH.getAttribute("Path").toString();
            sessionH.removeAttribute("Path");
        }
        ...
        //<<<<<<<<<<<<<<<<< Obtener los parametros que el Store va a devolver >>>>>>>>>>>>>>>>>
            ...
            if (Integer.parseInt(request.getParameter("Action")) == 1 || Integer.parseInt(request.getParameter("Action")) == 2 || Integer.parseInt(request.getParameter("Action")) == 3) {
                ...
                if (rsEx.next()) {
                    ...
                    if (Error.equalsIgnoreCase("0")) {
                        ...
                        CertificadoASATEJ.buildPDF(StrclAfiliado, StrPathPDF);
