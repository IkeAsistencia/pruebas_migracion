...
public class DetalleALineaMarron {

    private String clExpediente;
    private String DescripcionFalla;
    private String Observaciones;
    private String EsProgramado;
    private String FechaProgMom;
...
//------------------------------------------------------------------------------
    public String getEsProgramado() {        return EsProgramado;    }
    public void setEsProgramado(String EsProgramado) {        this.EsProgramado = EsProgramado;    }
//------------------------------------------------------------------------------
    public String getFechaProgMom() {        return FechaProgMom;    }
    public void setFechaProgMom(String FechaProgMom) {        this.FechaProgMom = FechaProgMom;    }
//------------------------------------------------------------------------------
    public String getClPais() {        return clPais;    }
    public void setClPais(String clPais) {        this.clPais = clPais;    }
//------------------------------------------------------------------------------
    public String getCodEnt() {        return CodEnt;    }
    public void setCodEnt(String CodEnt) {        this.CodEnt = CodEnt;    }
//------------------------------------------------------------------------------
    public String getCodMD() {        return CodMD;    }
...
//------------------------------------------------------------------------------
    ...
    public void setDsPais(String dsPais) {        this.dsPais = dsPais;    }
//------------------------------------------------------------------------------
    public String getDsEntFed() {        return dsEntFed;    }
    public void setDsEntFed(String dsEntFed) {        this.dsEntFed = dsEntFed;    }
//------------------------------------------------------------------------------
    public String getDsMunDel() {        return dsMunDel;    }
