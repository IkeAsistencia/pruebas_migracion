/*
 * cbCausaAsistencia.java
 *
 * Created on 20 de octubre de 2005, 11:19 AM
 *
 */
...
public class cbCausaAsistencia {
    ...
    private synchronized static boolean loadComboList()
    {
         ...
         {        
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clCausaAsistencia clLlave ,dsCausaAsistencia dsDesc FROM cCausaAsistenciaKM0 Order by dsCausaAsistencia");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Causa Asistencia");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbCausaAsistencia.getComboHash();
