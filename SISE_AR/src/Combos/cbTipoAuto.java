...
public class cbTipoAuto {
    ...
    private synchronized static boolean loadComboList()
    {
      ...
      {        
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT ClaveAMIS clLlave ,dsTipoAuto dsDesc FROM cTipoAuto Where CodigoMarca=");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Tipo Auto");
         }
      }
      return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbTipoAuto.getComboHash();
