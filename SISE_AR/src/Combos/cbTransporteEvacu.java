/*
 * cbTransporteEvacu.java
 *
 * Created on 20 de octubre de 2005, 01:38 PM
 *
...
public class cbTransporteEvacu {
    ...
    private synchronized static boolean loadComboList()
    {
      if(isConfigured == false)
      {
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoServicioEsp clLlave, dsTipoServicioEsp dsDesc FROM cTipoServBloqueoExp Where Clasificacion='EVACU' or Clasificacion='TODAS'");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Estatus de Transporte EVACU");
         }
      }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbTransporteEvacu.getComboHash();
