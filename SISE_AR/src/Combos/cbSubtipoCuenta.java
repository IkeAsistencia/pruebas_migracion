/*
 * cbSubtipoCuenta.java
 *
 * Created on 21 de octubre de 2005, 01:08 PM
 *
...
public class cbSubtipoCuenta {
    ...
    private synchronized static boolean loadComboList()
    {
         if(isConfigured == false)
         {
             ...
             try{
                 ...
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clSubTipoCuenta clLlave ,dsSubTipoCuenta dsDesc FROM cSubTipoCuenta where clSubTipoCuenta =");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de SubTipo Cuenta");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbSubtipoCuenta.getComboHash();
