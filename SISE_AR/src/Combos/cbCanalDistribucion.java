/*
 * cbCanalDistribucion.java
 *
 * Created on 20 de octubre de 2005, 11:14 AM
 *
 */
...
public class cbCanalDistribucion {
    ...
    private synchronized static boolean loadComboList()
    {
         ...
         try{
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clCanalDistribucion clLlave ,dsCanalDistribucion dsDesc FROM cCanalDistribucion order by dsCanalDistribucion");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Canal de Distribucion");
         }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbCanalDistribucion.getComboHash();
