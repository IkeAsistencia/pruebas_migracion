/*
 * cbServReqBloqueoExpress.java
 *
 * Created on 20 de octubre de 2005, 01:28 PM
 *
...
public class cbServReqBloqueoExpress {
    ...
    private synchronized static boolean loadComboList()
    {
      if(isConfigured == false)
      {
         ...
         {
             System.out.println("Entre a Load de Estatus de ServReqBloqueo Express");
         }
      }   
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbServReqBloqueoExpress.getComboHash();
