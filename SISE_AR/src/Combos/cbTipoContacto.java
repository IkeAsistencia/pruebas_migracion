...
public class cbTipoContacto {
    ...
    private synchronized static boolean loadComboList() {
        if (isConfigured == false) {
            ...
            try {
                ...
                ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoContacto clLlave ,dsTipoContacto dsDesc FROM cTipoContacto Order By dsTipoContacto");
                while (rs.next()) {
                ...
                System.out.println("Entre a Load de Tipo Contacto");
            }
        }
        return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue) {
        ...
        HashMap hshMap = cbTipoContacto.getComboHash();
