...
public class cbTipoGrua {
    ...
    private synchronized static boolean loadComboList()
    {
      ...
      {        
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoGrua clLlave ,dsTipoGrua dsDesc FROM cTipoGrua ORDER BY dsTipoGrua");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Tipo de Grua ");
         }
      }
      return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbTipoGrua.getComboHash();
