/*
 * cbProcedimientoSeguir.java
 *
 * Created on 20 de octubre de 2005, 03:51 PM
 *
 */
package Combos;
/*
...
public class cbProcedimientoSeguir {
    ...
    private synchronized static boolean loadComboList()
    {
     if(isConfigured == false)
     {
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clProceSeguir clLlave ,dsProceSeguir dsDesc FROM cProcedimientoSeguir order by dsProceSeguir");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Procedimiento Seguir");
         }
     }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbProcedimientoSeguir.getComboHash();
