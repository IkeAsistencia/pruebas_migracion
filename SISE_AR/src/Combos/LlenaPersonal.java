 ...
 * @version
 */
public class LlenaPersonal extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String StrCodParent = request.getParameter("clProveedor");
        String StrName = request.getParameter("strName");
        
        response.setContentType("text/html");
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Llena Personal del Proveedor</title>");
                out.println("</head>");
                out.println("<body><script>");

        cbItemParent hshObj = (cbItemParent)(cbProveedor.getComboHash().get(StrCodParent));        
