...
public class cbGiro {
    ...
    private synchronized static boolean loadComboList()
    {
         if(isConfigured == false)
         {
             ...
             try{
                 ...
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clGiro clLlave ,dsGiro dsDesc FROM cGiro order by dsGiro");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Giro");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbGiro.getComboHash();
