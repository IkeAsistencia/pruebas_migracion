...
public class cbClasificacionDelito {
    ...
    private synchronized static boolean loadComboList()
    {
         ...
         {        
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clClasifDelito clLlave ,dsClasifDelito dsDesc FROM cClasifDelito Order by dsClasifDelito");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Clasificacion Delito");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbClasificacionDelito.getComboHash();
