 ...
 * cbLugarEvento.java
 *
 * Created on 20 de octubre de 2005, 03:45 PM
 *
 */
...
public class cbLugarEvento {
    ...
    private synchronized static boolean loadComboList()
    {
         ...
         {         
             ...
             try{
                 ...
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clLugarEvento clLlave ,dsLugarEvento dsDesc FROM cLugarEvento order by dsLugarEvento");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Lugar Evento");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbLugarEvento.getComboHash();
