 ...
 * cbMoneda.java
 *
 * Created on 20 de octubre de 2005, 11:44 AM
 *
...
public class cbMoneda {
    ...
    private synchronized static boolean loadComboList()
    {
      if(isConfigured == false)
      {
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoMoneda clLlave, dsTipoMoneda  dsDesc From ctipomoneda order by dsTipoMoneda");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Estatus de Moneda");
         }
      }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbMoneda.getComboHash();
