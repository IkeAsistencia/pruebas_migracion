/*
 * cbTipoHabitacion.java
 *
 * Created on 20 de octubre de 2005, 02:30 PM
 */
...
public class cbTipoHabitacion {
    ...
    private synchronized static boolean loadComboList()
    {
      if(isConfigured == false)
      {
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoHabitacion clLlave ,dsTipoHabitacion dsDesc FROM cTipoHabitacion ORDER BY dsDesc");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Tipo Habitacion ");
         }
      }
      return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbTipoHabitacion.getComboHash();
