/*
 * cbEstatusCitasAbogado.java
 *
 * Created on 20 de octubre de 2005, 10:46 AM
 *
 */
package Combos;
/*
...
public class cbEstatusCitasAbogado {
    ...
    private synchronized static boolean loadComboList()
    {
         if(isConfigured == false)
         {
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clEstatus clLlave ,dsEstatus dsDesc FROM cEstatusCitasAbog order by dsEstatus");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Estatus de Citas de Abogado");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbEstatusCitasAbogado.getComboHash();
