...
public class cbTipoFalla {
    ...
    private synchronized static boolean loadComboList()
    {
      ...
      {        
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoFalla clLlave ,dsTipoFalla dsDesc FROM cTipoFalla Where DerivadoDe=");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Tipo de Falla ");
         }
      }
      return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbTipoFalla.getComboHash();
