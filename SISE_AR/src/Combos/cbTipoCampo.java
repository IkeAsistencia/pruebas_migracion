...
public class cbTipoCampo {
    ...
    private synchronized static boolean loadComboList()
    {
      ...
      {        
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoCampo clLlave ,TipoCampo dsDesc FROM cTipoCampo ORDER BY TipoCampo");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Tipo Campo ");
         }
      }
      return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbTipoCampo.getComboHash();
