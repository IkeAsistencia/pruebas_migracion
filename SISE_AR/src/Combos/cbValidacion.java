 ...
 * cbValidacion.java
 *
 * Created on 20 de octubre de 2005, 01:41 PM
 *
...
public class cbValidacion {
    ...
    private synchronized static boolean loadComboList()
    {
      if(isConfigured == false)
      {
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoValidacion clLlave, dsTipoValidacion dsDesc from cTipoValidacion order by dsTipoValidacion");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Estatus de Validacion");
         }
      }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbValidacion.getComboHash();
