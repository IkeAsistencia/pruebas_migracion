/*
 * cbRequerimientoEspecial.java
 *
 * Created on 20 de octubre de 2005, 03:53 PM
 *
 */
package Combos;
/*
...
public class cbRequerimientoEspecial {
    ...
    private synchronized static boolean loadComboList()
    {
     if(isConfigured == false)
     {
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clRequerimientoEsp clLlave ,dsRequerimientoEsp dsDesc FROM cRequerimientoEsp order by dsRequerimientoEsp");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Estatus de Expediente");
         }
     }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbRequerimientoEspecial.getComboHash();
