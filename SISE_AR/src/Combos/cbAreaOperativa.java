/*
 * cbAreaOperativa.java
 *
 * Created on 20 de octubre de 2005, 10:15 AM
 *
 */
...
public class cbAreaOperativa {
    ...
    private synchronized static boolean loadComboList()
    {
         ...
         {          
             ...
             try{
                 ...
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clAreaOperativa clLlave ,dsAreaOperativa dsDesc FROM cAreaOperativa Order by dsAreaOperativa");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Area Operativa");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbAreaOperativa.getComboHash();
