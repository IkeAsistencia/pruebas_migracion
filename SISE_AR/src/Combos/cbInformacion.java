 ...
 * cbInformacion.java
 *
 * Created on 20 de octubre de 2005, 10:58 AM
 *
...
public class cbInformacion {
    ...
    private synchronized static boolean loadComboList()
    {
      if(isConfigured == false)
      {
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoInformacion clLlave, dsTipoInformacion dsDesc From cTipoInformacion Order by dsTipoInformacion");
             while(rs.next())
             {
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbInformacion.getComboHash();
