/*
 * cbPersonaqueReporta.java
 *
 * Created on 20 de octubre de 2005, 01:04 PM
 *
...
public class cbPersonaqueReporta {
    ...
    private synchronized static boolean loadComboList()
    {
      if(isConfigured == false)
      {
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoPerReporta clLlave, dsTipoPersonaRep dsDesc From cTipoPersonaReporta order by dsTipoPersonaRep");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Estatus de Persona que Reporta");
         }
      }
         return true;
    }
   ...
   public static HashMap getComboHash()
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbPersonaqueReporta.getComboHash();
