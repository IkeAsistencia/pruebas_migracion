...
public class cbGerenciaRegional {
    ...
    private synchronized static boolean loadComboList()
    {
         if(isConfigured == false)
         {
             ...
             try{
                 ...
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clGerenciaReg clLlave ,dsGerencia dsDesc FROM cGerenciaRegional order by dsGerencia");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Gerencia Regional");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbGerenciaRegional.getComboHash();
