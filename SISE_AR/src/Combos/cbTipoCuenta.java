...
public class cbTipoCuenta {
    ...
    private synchronized static boolean loadComboList()
    {
      ...
      {        
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoCuenta clLlave ,dsTipoCuenta dsDesc FROM cTipoCuenta Order By dsTipoCuenta");
             while(rs.next())
             { 
         ...
         {
             System.out.println("Entre a Load de Tipo Cuenta");
         }
      }
      return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbTipoCuenta.getComboHash();
