...
public class cbTipoObjeto {
    ...
    private synchronized static boolean loadComboList()
    {
      ...
      {        
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoObjeto clLlave ,TipoObjeto dsDesc FROM cTipoObjeto ORDER BY TipoObjeto");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Tipo Objeto ");
         }
      }
      return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbTipoObjeto.getComboHash();
