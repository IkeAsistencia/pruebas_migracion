 ...
 * cbEmpresaSEA.java
 *
 * Created on 20 de octubre de 2005, 10:05 AM
 *
 */
package Combos;
/*
...
public class cbEmpresaSEA {
    ...
    private synchronized static boolean loadComboList()
    {
         if(isConfigured == false)
         {
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clEmpresaSEA clLlave ,dsEmpresaSEA dsDesc FROM cEmpresaSEA order by dsEmpresaSEA");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Empresa SEA");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbEmpresaSEA.getComboHash();
