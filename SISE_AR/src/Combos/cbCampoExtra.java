 ...
 * cbCampoExtra.java
 *
 * Created on 20 de octubre de 2005, 11:05 AM
 *
 */
...
public class cbCampoExtra {
    ...
    private synchronized static boolean loadComboList()
    {
         ...
         {        
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clCampoExtra clLlave ,Nombre dsDesc FROM cCampoExtra WHERE clCampoExtra=");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Campo Extra");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbCampoExtra.getComboHash();
