 ...
 * cbBanco.java
 *
 * Created on 20 de octubre de 2005, 10:56 AM
 */
...
public class cbBanco {
    ...
    private synchronized static boolean loadComboList()
    {
         ...
         {        
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clBanco clLlave ,Nombre dsDesc FROM cBanco order by Nombre");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Bancos");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbBanco.getComboHash();
