 ...
 * @version
 */
public class EjecutaAccionRecupera extends HttpServlet {
        ...
        try{
            ...
            if(rs.next()){
                ...
                if (Integer.parseInt(request.getParameter("Action"))==1){
                    ...
                    String StrSql="";
                    String Folio="0";
                    StrSql = "sp_CalculaMaxFolioRecupDaños";
                    ...
                    StrSentence = StrSentence + "(" + StrFields + ",Folio,FechaRecupera) values (" + StrVals + "," + Folio + ",getdate())";
                }
