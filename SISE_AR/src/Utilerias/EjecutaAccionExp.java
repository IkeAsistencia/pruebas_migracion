/*
 * EjecutaAccionExp.java
 *
 * Created on 02 de Junio de 2010, 05:16 PM
 */
package Utilerias;
 ...
 * @version
 */
public class EjecutaAccionExp extends HttpServlet {
                                ...
                                if (StrType.equalsIgnoreCase("tinyint") || StrType.equalsIgnoreCase("bigint") || StrType.equalsIgnoreCase("binary") || StrType.equalsIgnoreCase("bit") || StrType.equalsIgnoreCase("decimal") || StrType.equalsIgnoreCase("float") || StrType.equalsIgnoreCase("int") || StrType.equalsIgnoreCase("money") || StrType.equalsIgnoreCase("numeric") || StrType.equalsIgnoreCase("real") || StrType.equalsIgnoreCase("smallint") || StrType.equalsIgnoreCase("smallmoney") || StrType.equalsIgnoreCase("uniqueidentifier") || StrType.equalsIgnoreCase("varbinary")) {
                                    ...
                                    if (request.getParameter(strNameF).toString().equalsIgnoreCase("") && (rsInfo.getString("nullable").equalsIgnoreCase("Si"))) {
                                        ...
                                        if (strNameF.equalsIgnoreCase("Clave")) {
                                            System.out.println("sp_GuardaClaveEncriptada '" + request.getParameter("Clave") + "'" + "," + " '" + request.getParameter("clCuenta") + "'");
                ...
                if (Integer.parseInt(request.getParameter("Action")) == 2) {
                    ...
                    while (rsInfo.next()) {
                        if (request.getParameter(rsInfo.getString("NameF")) != null) {
                            ...
                            //  System.out.println(rsInfo.getString("LlavePrimaria"));
                            if (rsInfo.getString("LlavePrimaria").equalsIgnoreCase("Si") && rsInfo.getString("Identit").equalsIgnoreCase("No")) {
                                out.println("La llave primaria no debe quedar en blanco, por favor vuelva a intentarlo");
                                out.close();
                                strNameF = null;
...
//                  //// **************BITACORA *************////
                    ...
                    try {
                        ...
                        System.out.println("Error EjecutaAccionExp.java: Bitacora");
                        bit.printStackTrace();
                    } finally {
                        datasent = null;
                        ht = null;
...
//                    if (Integer.parseInt(request.getParameter("Action")) == 1 && request.getParameter("clCuenta").equalsIgnoreCase("1594")) {
//                        String Strparam = "", line = "", resp = "", StrUrl = "";
//                        String StrclRespuesta = "";
//                        ResultSet rsUrl = null;
//
////                        System.out.println("sp_GuardaEnvioMoviStar '" + strLlave + "'");
////                        rsUrl = UtileriasBDF.rsSQLNP("sp_GuardaEnvioMoviStar '" + strLlave + "'");
//
//                        if (rsUrl.next()) {
//                            StrclRespuesta = rsUrl.getString("clRespuesta");
//                            StrUrl = rsUrl.getString("Url");
//                            Strparam = rsUrl.getString("Param");
//                        }
//
...
//                        }
//
////                        System.out.println("sp_UpdateRespuestaMoviStar '" + StrclRespuesta + "','" + resp + "',''");
////                        UtileriasBDF.ejecutaSQLNP("sp_UpdateRespuestaMoviStar '" + StrclRespuesta + "','" + resp + "',''");
//                    }
            ...
            out.println("Problema al registrar el movimiento (verifique formato de fechas y campos numéricos sin separador de coma)" + e);
        } finally {
            out.println("</body>");
            out.println("</html>");
