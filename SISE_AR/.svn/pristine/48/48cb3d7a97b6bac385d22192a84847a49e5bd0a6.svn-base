/*
 * cbConceptoCosto.java
 *
 * Created on 20 de octubre de 2005, 01:08 PM
 *
  */
...
public class cbConceptoCosto {
    ...
    private synchronized static boolean loadComboList()
    {
         ...
         {        
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clConcepto clLlave ,dsConcepto dsDesc FROM cConceptoCosto Where clAreaOperativa= 4 Order by dsConcepto");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Concepto de Costo");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbConceptoCosto.getComboHash();
