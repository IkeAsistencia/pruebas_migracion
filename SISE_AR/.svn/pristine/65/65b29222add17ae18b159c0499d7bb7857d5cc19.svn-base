/*
 * cbEstatusFolioAfianzadora.java
 *
 * Created on 20 de octubre de 2005, 10:50 AM
 *
 */
package Combos;
/*
...
public class cbEstatusFolioAfianzadora {
    ...
    private synchronized static boolean loadComboList()
    {
         if(isConfigured == false)
         {
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clEstatus clLlave ,dsEstatus dsDesc FROM cEstatusFolioAfian Order by dsEstatus");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Estatus de Folio Afianzadora");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbEstatusFolioAfianzadora.getComboHash();
