 ...
 * cbZona.java
 *
 * Created on 20 de octubre de 2005, 01:44 PM
 *
...
public class cbZona {
    ...
    if(isConfigured == false)
     {
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clZona clLlave, dsZona dsDesc From cZona Order by dsZona");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Estatus de Zona");
         }
     }   
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbZona.getComboHash();
