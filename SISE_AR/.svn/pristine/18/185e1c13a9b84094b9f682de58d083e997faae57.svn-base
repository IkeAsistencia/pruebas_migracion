        ...
        <script type="text/javascript">
            ...
            function fnHabilitaChkRetencion(clCuenta) {
                ...
                if (clCuenta == '1302' || clCuenta == '1303' || clCuenta == '1304' || clCuenta == '1305' || clCuenta == '1307' || clCuenta == '1313' || clCuenta == '1317' || clCuenta == '1320' || clCuenta == '1321' ||
                        ...
                        clCuenta == '1357' || clCuenta == '1367' || clCuenta == '1368' || clCuenta == '1372' || clCuenta == '1373' || clCuenta == '1374' || clCuenta == '1375' || clCuenta == '1383' || clCuenta == '1384' ||
                        clCuenta == '1398' || clCuenta == '1407' || clCuenta == '1408' || clCuenta == '1409' || clCuenta == '1413' || clCuenta == '1414') {
                    if (document.all.clEstatus.value == '2') {
