/*
 * cbMotivoSiniestro.java
 *
 * Created on 20 de octubre de 2005, 03:56 PM
 *
 */
...
public class cbMotivoSiniestro {
    ...
    private synchronized static boolean loadComboList()
    {
         ...
         {        
             ...
             try{
                 ...
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clMotivoSiniestro clLlave ,dsMotivoSiniestro dsDesc FROM cMotivoSiniestro order by dsMotivoSiniestro");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Motivo Siniestro");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbMotivoSiniestro.getComboHash();
