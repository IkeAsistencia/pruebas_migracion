/*
 * cbEstatusAfianzadora.java
 *
 * Created on 20 de octubre de 2005, 10:31 AM
 *
 */
package Combos;
/*
...
public class cbEstatusAfianzadora {
    ...
    private synchronized static boolean loadComboList()
    {
         if(isConfigured == false)
         {
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clEstatus clLlave ,dsEstatus dsDesc FROM cEstatusAfianzadora Order by dsEstatus");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Estatus de Afianzadora");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbEstatusAfianzadora.getComboHash();
