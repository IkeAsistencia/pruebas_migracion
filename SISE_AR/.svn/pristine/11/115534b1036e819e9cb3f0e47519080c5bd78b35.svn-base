...
<html>
    ...
    <body class="cssBody">
        ...
        <%=MyUtil.ObjComboC("Tipo de Líquido", "clLiquidoAuto", AV != null ? AV.getDsTipoLiquido() : "", true, true, 30, 368, "", "Select clLiquidoAuto, dsLiquidoAuto from cLiquidoAuto order by dsLiquidoAuto ", "", "", 30, true, true)%>
        ...
        <%=MyUtil.DoBlock("Detalle de Otros Líquidos", -115, -10)%>
