...
<html>
    <head>
        <title>Cobertura de Proveedor Funerario</title>
    </head>
    ...
    <%
            ...
            MyUtil.InicializaParametrosC(816, Integer.parseInt(StrclUsrApp));
    %>
    ...
    <frameset framespacing='0' noresize frameborder='no' rows="250,*">
        <frame frameborder='no' noresize name='DetalleCobertura' id='DetalleCobertura' src='DetalleCobxProvF.jsp'></frame>
