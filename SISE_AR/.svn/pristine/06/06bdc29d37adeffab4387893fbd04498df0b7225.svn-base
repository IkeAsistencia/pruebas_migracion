/*
 * cbFormaEvacuacion.java
 *
 * Created on 20 de octubre de 2005, 10:59 AM
 *
 */
package Combos;
/*
...
public class cbFormaEvacuacion {
    ...
    private synchronized static boolean loadComboList()
    {
         if(isConfigured == false)
         {
             ...
             try{
                 ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clFormaEvacuacion clLlave ,dsFormaEvacuacion dsDesc FROM cFormaEvacuacion order by dsFormaEvacuacion");
                 while(rs.next())
                 {
             ...
             {
                 System.out.println("Entre a Load de Forma Evacuacion");
             }
         }
         return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbFormaEvacuacion.getComboHash();
