...
public class cbTipoBenef {
    ...
    private synchronized static boolean loadComboList()
    {
      ...
      {        
         ...
         try{
             ...
             ResultSet rs = UtileriasBDF.rsSQLNP("SELECT clTipoBeneficiario clLlave, dsTipoBeneficiario dsDesc FROM cTipoBeneficiario");
             while(rs.next())
             {
         ...
         {
             System.out.println("Entre a Load de Tipo Beneficiario en Expediente");
         }
      }
      return true;
    }
    ...
    public static String GeneraHTML(int pSize, String pValue){
        ...
        HashMap hshMap=cbTipoBenef.getComboHash();
