...
<html>
    ...
    <body class="cssBody">
        ...
        <% if (rs.next()) { %>
            ...
            <%=MyUtil.ObjComboC("Se Quejó", "clQuejo", rs.getString("dsQuejo"), true, true, 500, 180, "", "select clQuejo, dsQuejo from cSeQuejo where Activo = 1", "", "", 100, false, false)%>            
        ...
        <% } else { %>
            ...
            <%=MyUtil.ObjComboC("Se Quejó", "clQuejo", "", true, true, 500, 180, "", "select clQuejo, dsQuejo from cSeQuejo where Activo = 1", "", "", 100, false, false)%> 
