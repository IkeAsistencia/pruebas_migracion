...
<html>
    ...
    <body class="cssBody">
        ...
        <%
        MyUtil.InicializaParametrosC(6116,Integer.parseInt(StrclUsrApp));    // se checan permisos de alta,baja,cambio,consulta de esta pagina
        ...
        <% if (rs.next()) { %>
            ...
            <%=MyUtil.ObjChkBox("Queja o Inconformidad","EsQuejaVTR", Queja != null ? Queja.getDsQueja() : "", false,false,550,65,"0","Queja","Inconformidad","")%>
