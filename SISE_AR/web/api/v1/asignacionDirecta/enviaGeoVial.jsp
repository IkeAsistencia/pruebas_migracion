...
<%@page contentType="text/html" pageEncoding="ISO-8859-1" language="java" %><%@page import="com.google.gson.Gson,java.sql.ResultSet,Utilerias.UtileriasBDF,Seguridad.SeguridadC,ar.com.ike.util.rest.SimpleRESTCall,ar.com.ike.asignacion.to.AsignacionDirecta,ar.com.ike.asignacion.to.AsignacionDirectaResponse"%>
    ...
    if ( !sExpediente.equals("0") && !sProveedor.equals("0") && !sTEC.equals("0") && !sUsrApp.equals("0" )) {
        ...
        if (rs.next()) {
            try {
                ...
                asigTec.marca = rs.getString("dsMarcaAuto");
                asigTec.tipo = rs.getString("dsTipoAutoGenerico");
                asigTec.refVisualesOrigen = rs.getString("referencias");
                asigTec.refVisualesDestino = rs.getString("referenciasDest");

                Gson gson = new Gson();
                String postString = gson.toJson(asigTec);
                ...
                UtileriasBDF.ejecutaSQLNP("st_WSActualizaDatosExp " + sExpediente + ",'" +  adTECR.casoid  + ":" + ( adTECR.resultado ?"OK":"ERR") + "', " + sProveedor + ", 2 ");
