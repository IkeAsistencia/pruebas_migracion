<%@page contentType="text/html; charset=iso-8859-1" import="Utilerias.UtileriasBDF,Seguridad.SeguridadC, Utilerias.LoadServicios,java.sql.ResultSet"%>
...
<html>
    ...
    <body bgcolor='#062f67' onload="fnValidaPermiso();">
        ...
        %>Fuera de Horario<%
            ...
            bf.append("st_GetPermisoMiniBannerMonitoreo ").append(strclUsr);
        ...
        <% strServicios = LoadServicios.getstrServicios(strclUsr); %>
        <% } else { %>
        <p></p>
        <% }%>

        <input type="hidden" id="valor" name="valor"  value= "<%=strServicios%>"><%
            //<<<Limpia Variables>>>
            strServicios = null;
            strclUsr = null;
            rs.close();
