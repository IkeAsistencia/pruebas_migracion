<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.Timestamp,java.util.Calendar,Utilerias.Grafica,Utilerias.UtileriasBDF,java.util.Iterator,java.util.Map,java.util.LinkedHashMap,Utilerias.Grafica,java.sql.ResultSet,Utilerias.UtileriasBDF,Seguridad.SeguridadC" errorPage="" %>
<%@page pageEncoding="iso-8859-1"%>
<html>
    <head><title>Reporte de Asuntos Pendientes</title>    
    ...
    <body class="cssBody">
        ...
        String StrQry="";
            ...
            if (SeguridadC.verificaHorarioC(Integer.parseInt(StrclUsrApp)) != true) {
                ...
                MyUtil.InicializaParametrosC(696,Integer.parseInt(StrclUsrApp));
        %>
        <form name='frmBusq' id='frmBusq' method='post' action='../EstadisticosGNP/RptAsuntosPendientes.jsp'>
        ...
        StrSql.append("st_GNPRptAsuntosPendientes '").append(StrclAnio).append("','").append(clMes).append("','1'");
        StrQry="st_GNPRptAsuntosPendientes "+StrclAnio+","+clMes;
        ...
        <div style='position:absolute; z-index:20; left:10px; top:120px;'> 
            <font class="STableTitRpt"> <center>Reporte de Asuntos Pendientes<br><br><%=Mes%> - <%=StrclAnio%></center> </font>
            <br>            
            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                <tr> 
                    <td  class="STableTit">REGIONAL</td>
                    <td  width="15%" class="STableTit">ESTADO</td>
                    <td  width="15%" class="STableTit">DEL MES</td>
                    <td  width="15%" class="STableTit">DEL AÑO</td>
                    <td  width="15%" class="STableTit">AÑOS ANTERIORES</td>
                    <td  width="15%" class="STableTit">TOTAL PENDIENTES</td>
                </tr>
                <%
                while(it.hasNext()){
                    key = ( String ) it.next();
            ...
            //String SqlGrafica = "st_GNPRptAsuntosPendientes2FitoC '" + StrclAnio + "','" + clMes +"'";
            String SqlGrafica = "st_GNPRptAsuntosPendientes '" + StrclAnio + "','" + clMes +"','3'";            
                %>
            </table> 
            <br>
            <table border="0">
                <tr><td>                    
                    <IMG SRC="..\\SGrafica?type=<%=SqlGrafica%>&dsCampo=dsRegional&dsCampoCan=&Tipo=4&Pagina=696&Titulo=Pendientes en Asistencia Legal" BORDER=1/>
                </td></tr>
            </table>       
            <%
                ...
                SqlGrafica = "st_GNPRptAsuntosPendientes '" + StrclAnio + "','" + clMes +"','2'";    
                
                UtileriasBDF.rsTableNP(SqlGrafica,strSalida);
            %>  <%=strSalida.toString()%> <br><br> <%
