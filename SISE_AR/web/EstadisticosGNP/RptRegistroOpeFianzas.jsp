    ...
    <body class="cssBody">
        ...
        %>Fuera de Horario<%
            ...
            return;
                ...
                MyUtil.InicializaParametrosC(699,Integer.parseInt(StrclUsrApp));
        %>
        <form name='frmBusq' id='frmBusq' method='post' action='../EstadisticosGNP/RptRegistroOpeFianzas.jsp'>
            <%=MyUtil.ObjComboC("Año","clAnio","",true,true,20,30,"","st_GetAnio2","","",25,true,true)%>            
            <%=MyUtil.ObjComboC("Fianzas","clTipo","",true,true,180,30,"","Select '1' 'clTipo','Exhibidas' 'dsTipo' Union Select '2' 'clTipo','Recuperadas' 'dsTipo'","","",25,true,true)%>
        ...
        <%
            ...
            StrSql.append("st_GNPRptRegistroOperacionFianzas '").append(StrclAnio).append("','").append(clTipo).append("'").append(",'1'");
            StrQry="st_GNPRptRegistroOperacionFianzas "+StrclAnio+","+clTipo;
        ...
        <div style='position:absolute; z-index:20; left:10px; top:120px;'> 
            ...
            <table width="130%" border="0" cellspacing="1" cellpadding="1">
                <tr> 
                    <td colspan="3" class="STableTit">FIANZAS <%=dsTipoExped%></td>
                    ...
                    <td width="4%" class="STableTit">ACUMULADO ANUAL</td>
                </tr>
                <tr> 
        ...
        <%
            ...
            StrSqlG1.append("st_GNPRptRegistroOperacionFianzas '").append(StrclAnio).append("','").append(clTipo).append("'").append(",'2'");          
            //System.out.println(StrSqlG1.toString());
            StrSqlG2.append("st_GNPRptRegistroOperacionFianzas '").append(StrclAnio).append("','").append(clTipo).append("'").append(",'3'");            
