...
<html>
    <head><title>Registro de la Operacion</title>
    ...
    <body class="cssBody">
        ...
        %>Fuera de Horario<%
            ...
            return;
                ...
                MyUtil.InicializaParametrosC(689,Integer.parseInt(StrclUsrApp));
        %>
        <form name='frmBusq' id='frmBusq' method='post' action='../EstadisticosGNP/RptRegistroOpe.jsp'>
            <%=MyUtil.ObjComboC("Año","clAnio","",true,true,20,30,"","st_GetAnio2","","",25,true,true)%>
            <%=MyUtil.ObjComboC("Expedientes","clTipo","",true,true,180,30,"","Select '1' 'clTipo','Turnados' 'dsTipo' Union Select '2' 'clTipo','Terminados' 'dsTipo'","","",25,true,true)%>
        ...
        <%
            ...
            StrSql.append("st_GNPRptRegistroOperacion '").append(StrclAnio).append("','").append(clTipo).append("','1'");   
            StrQry="st_GNPRptRegistroOperacion "+StrclAnio+","+clTipo;
        ...
        <div style='position:absolute; z-index:20; left:10px; top:120px;'> 
            ...
            <table width="120%" border="0" cellspacing="1" cellpadding="1">
                <tr> 
                    <td colspan="3" class="STableTit">ASUNTOSsss <%=dsTipoExped%></td>
                ...
                <tr> 
                    <td class="STableTexto"><%=clAnio%></td>
        ...
        <%
            ...
            StrSqlG1.append("st_GNPRptRegistroOperacion '").append(StrclAnio).append("','").append(clTipo).append("','2'");                
            //System.out.println(StrSqlG1.toString());
            StrSqlG2.append("st_GNPRptRegistroOperacion '").append(StrclAnio).append("','").append(clTipo).append("','3'");  
            //System.out.println(StrSqlG2.toString());
        %>
        <div style='position:absolute; z-index:20; left:10px; top:520px;'>            
        ...
        <div style='position:absolute; z-index:20; left:530px; top:520px;'>            
