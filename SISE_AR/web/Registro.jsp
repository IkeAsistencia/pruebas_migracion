...
<html>
    ...
    <body onload="fnValidaRes()" style=" ">
        ...
        <form action="<%=url%>" method="post" id="frm1">
            ...
            <div id="divPrincipal" style="position:absolute; left:20%; top:30%">
                ...
                <div id="inputArea" style="position:absolute; z-index:20; left:115px; top:130px;">
                    ...
                    <label id="lblPass" for="txtContraseña" style="color:#FFFFFF; font-size:17px; font-variant:small-caps; font-weight:bold;" onblur="alert();">contraseña</label>
                    <input id="Pass" name="Pass" type="password" autocomplete="off" size="10" maxlength="10" onblur="fnReplaceScripting(this.value, this.id);" />
                    <div class="buttons">
        ...
        <div id="piepag" style="position:absolute; z-index:20; bottom:10px">
            <p style="font-size:10px;">ESTE SITIO SE VE MEJOR CON <a href="http://www.microsoft.com/latam/windows/internet-explorer/">INTERNET EXPLORER 9</a> ó SUPERIOR.</p>
