...
<html>
    ...
    <body class="cssBody" onload="fnVerificaFecha();fnServAds();fnLimpiaFechas();">
        ...
        <div class='VTable' style='position:absolute; z-index:25; left:400px; top:15px;'><p align="center"><font color="navy" face="Arial" size="3" ><b><i> Renta de Autos (Convencional/Exoticos ó de Lujo) </i></b>  <br> </p></div>
        ...
        <%=MyUtil.ObjInputF("Devolución <Strong>(AAAA-MM-DD hh:mm)</Strong>","FechaD",conciergeauto!=null ? conciergeauto.getFechaD().trim() : "",true,true,30,370,"",true,true,20, 2, "")%>  </div>    
        <%=MyUtil.ObjInput("Lugar de Devolución","LugarDev",conciergeauto!=null ? conciergeauto.getLugarDev().trim() : "",true,true,30,410,"",true,true,75)%>
        <%=MyUtil.ObjInput("Costo por Hora/Día","CostoH",conciergeauto!=null ? conciergeauto.getCostoH().trim() : "",true,true,30,450,"",false,false,10,"EsNumerico(this)")%>
        ...
        <%=MyUtil.ObjInput("Pol.Cancelación","PCancel", conciergeauto!=null ? conciergeauto.getPCancel().trim() : "",true,true,30,730,"",false,false,50)%>
