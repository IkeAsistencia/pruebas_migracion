...
<html>
    ...
    <body class="cssBody" >
        ...
        <div class='VTable' style='position:absolute; z-index:25; left:400px; top:15px;'><p align="center"><font color="navy" face="Arial" size="3" ><b><i> REMINDER </i></b></font><br></p></div>
        ...
        <%
                    ...
                    DAOCSReminder daoCSReminder = null;
                    CSReminder W = null;
                    ...
                    if (request.getParameter("clCSreminder") != null) {
                        StrclCSreminder = request.getParameter("clCSreminder").toString();
                        session.setAttribute("clCSreminder", StrclCSreminder);
                    } else {
                        if (session.getAttribute("clCSreminder") != null) {
                            StrclCSreminder = session.getAttribute("clCSreminder").toString();
                        }
                    }
                ...
                String StrclPaginaWeb = "6127";
                session.setAttribute("clPaginaWebP", StrclPaginaWeb);

         
            //<<<<<<<<<<<< Servlet Generico >>>>>>>>>>>
            String Store = "";
            Store = "st_GuardaCSReminder,st_ActualizaCSReminder";
            ...
            session.setAttribute("Commit", Commit);
                 ...
                 if (StrclUsr != null) {
                    daoCSReminder = new DAOCSReminder();
                     W = daoCSReminder.getCSReminder(StrclAsistencia);
                }
                if (StrclUsr != null) {
    ...
    <div id="InfoOculta"  name="InfoOculta" style='visibility:hidden'>                                                            
    <% { %>         
        ...
        <%=MyUtil.DoBlock("Descripcion REMINDER", 100, 220)%>
