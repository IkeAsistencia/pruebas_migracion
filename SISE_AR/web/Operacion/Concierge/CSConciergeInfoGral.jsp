...
<body class="cssBody" onload="fnVerificaFecha();">
   ...
   if(SeguridadC.verificaHorarioC(Integer.parseInt(strclUsr)) != true){
    ...
    <%=MyUtil.ObjInput("Información Solicitada","InfoSolicitada",conciergeinfogral!=null ? conciergeinfogral.getInfoSolicitada()  : "",true,true,30,260,"",true,true,75)%>
    ...
    <%=MyUtil.ObjInputF("Fecha Término <Strong>(AAAA-MM-DD hh:mm)</Strong>","FechaTermino",conciergeinfogral!=null ? conciergeinfogral.getFechaTermino()  : "",true,true,240,340,"",false,false,20, 2, "")%>  </div>
