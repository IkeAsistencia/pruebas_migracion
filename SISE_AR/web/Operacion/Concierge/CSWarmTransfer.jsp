...
<html>
    ...
    <body class="cssBody">
        ...
        <%=MyUtil.ObjTextArea("Descripción del Evento", "DescripcionEvento", rsAsist.getString("Descripcion"), "83", "3", true, true, 30, 120, "", true, true)%>
        ...
        <%=MyUtil.ObjInput("Teléfono Contacto", "Contacto", rsAsist.getString("TelefonoContacto"), true, true, 30, 220, "", true, true, 20)%>
        ...
        <div id="TelCallCenterDIV" name="TelCallCenterDIV" style="position:absolute; z-index:131; left:0px;">
            <%=MyUtil.ObjComboC("Teléfono", "clTelCallCenter", rsAsist.getString("Telefono"), true, true, 30, 260, "0", "select clCallCenter, Telefono from CSTelefonoxCallCenter order by clCallCenter asc", "", "", 30, false, false)%>
        </div>
        <%=MyUtil.ObjInputDiv("Teléfono", "OtroCallCenter", rsAsist.getString("OtroCallCenter"), true, true, 30, 300, "", false, false, 20, "", "OtroCallCenterDIV")%>
        ...
        <%=MyUtil.ObjTextArea("Descripción del evento", "DescripcionEvento", "", "83", "3", true, true, 30, 120, "", true, true)%>
        <%=MyUtil.ObjInput("Fecha de Apertura", "FechaRegistro", "", false, false, 650, 80, "", false, false, 20)%>
        <%=MyUtil.DoBlock("Datos Generales del Evento", 10, 10)%>

        <%=MyUtil.ObjInput("Teléfono Contacto", "Contacto", "", true, true, 30, 220, "", true, true, 20)%>
        ...
        <div id="TelCallCenterDIV" name="TelCallCenterDIV" style="position:absolute; z-index:131; left:0px;">
            <%=MyUtil.ObjComboC("Teléfono", "clTelCallCenter", "", true, true, 30, 300, "0", "select clCallCenter, Telefono from CSTelefonoxCallCenter order by clCallCenter asc", "", "", 30, false, false)%>
        </div>
        <%=MyUtil.ObjInputDiv("Teléfono", "OtroCallCenter", "", true, true, 30, 300, "", false, false, 20, "", "OtroCallCenterDIV")%>
        ...
        <table style="position:absolute; z-index:31; left:20px; top:430px;" class='VTable' border='1' cellpadding='0'>
            <tr class="TTable"><td></td><td>Beneficiario</td><td>Breve Descripción</td><td>Vendedor</td><td>Teléfono</td></tr>
            <%
                    while (rsWT.next()) {
            %>
