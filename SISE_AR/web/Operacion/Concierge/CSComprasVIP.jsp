...
<body class="cssBody" onload="">
    ...
    <%=MyUtil.ObjInput("Teléfono","Telefono", conciergecomprasvip!=null ? conciergecomprasvip.getTelefono() : "",true,true,450,535, "",false,false,25)%>
    ...
    <%=MyUtil.ObjInput("Pol.Cancelación","PCancel",conciergecomprasvip!=null ? conciergecomprasvip.getPCancel() : "",true,true,30,690,"",false,false,50)%>
