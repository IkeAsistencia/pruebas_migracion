...
<html>
    <head>
        ...
        <body class="cssBody" onload="fnAccionesAlta();">
            ...
            <%=MyUtil.ObjComboC("Sala", "clSala", EVIP != null ? EVIP.getDsSala() : "", true, true, 400, 190, "", "select clSala, dsSala from CScSalaVIP where clCuenta = "+StrclCuenta, "", "", 5, true, false)%>     
            ...
            <%=MyUtil.ObjTextArea("Domicilio del Tarjetahabiente (máx. 500 caracteres)", "DomFiscal", EVIP != null ? EVIP.getDomFiscal() : "", "80", "8", true, true, 400, 1160, "", false, false)%>
             ...
             <div id="btnAutorizar" name="btnAutorizar" style="position: absolute; z-index: 125; left: 850px; top: 1190px;">
                 <label class="terminos">
                    <%=StrNumeroAutorizacion%>
                </label>
                <BR>
                <input type='button' class='cBtn' style="position: absolute;left: 25px; top: 25px;" value='Autorizar' onClick="fnAbrirLink()">
            </div>
