<%-- 
    Document   : CSAbrirBitacoraNU
    Created on : 17/11/2010, 10:21:42 AM
    Author     : rfernandez
--%>
...
<html>
    <head>
        <title>Bitacora Concierge</title>
    ...
    <body class="cssBody" onLoad="">
        ...
        <form id='Forma' name ='Forma'  action='CSWows.jsp?' method='post'>
            <div class='VTable' style='position:absolute; z-index:25; left:10px; top:10px; right:10px;'>
                <p align="center">
                    <font color="navy" face="Arial" size="2" ><b><i>Historico de Cambios</i></b></font><br>
                </p>
            </div>
            <div class='VTable' style='position:absolute; z-index:25; left:10px; top:30px;'>
                <%StringBuffer strSalida = new StringBuffer();

                        UtileriasBDF.rsTableNP("st_CSBitacoraConcierge " + StrclConcierge, strSalida);
                %>
                <%=strSalida.toString()%>
