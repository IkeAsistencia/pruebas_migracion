...
<body class="cssBody" onload="fnVerificaFecha();fnLimpiaFechas();">
    ...
    <%=MyUtil.ObjChkBox("Niños","Ninos", conciergetour!=null ? conciergetour.getNinos() :"",true,true,130,220,"","SI","NO","EdadesNinos()")%>
    ...
    <%=MyUtil.ObjInput("Pol.Cancelación","PCancel", conciergetour!=null ? conciergetour.getPCancel() :"",true,true,30,750,"",false,false,50)%>
