...
<html>
    <head>
        <title>Detalle Asistencia Traslado</title>
    ...
    <body class="cssBody" OnLoad="fnMuestraDivs();">
        ...
        iRowPx = iRowPx + 30;
        %>
        <%=MyUtil.ObjInput("Calle", "Calle",AH != null ? AH.getCalle() : "", true, true, 30, iRowPx, "", false, false, 58)%>
        ...
        <div id='divEmpleada'>
            <%=MyUtil.ObjInput("Cantidad de Horas", "CantHorasL",AH != null ? AH.getCantHorasL() : "", true, true, 30, iRowPx, "", false, false, 10)%>
        </div>
        
        <div id='divLavanderia'>
            <%=MyUtil.ObjInput("Peso", "PesoL",AH != null ? AH.getPesoL() : "", true, true, 30, iRowPx, "", false, false, 10)%>
            <%=MyUtil.ObjInput("Cantidad de Prendas", "CantPrendasL",AH != null ? AH.getCantPrendasL() : "", true, true, 475, iRowPx, "", false, false, 10)%>
        </div>
        
        <div id='divTapizado'>
            <%=MyUtil.ObjInput("Tipo de Mueble", "MuebleL",AH != null ? AH.getMuebleL() : "", true, true, 30, iRowPx, "", false, false, 50)%>
            <%=MyUtil.ObjInput("Tipo de Tapizado", "TapizadoL",AH != null ? AH.getTapizadoL() : "", true, true, 475, iRowPx, "", false, false, 25)%>
        </div>
        
        <div id='divAlfombras'>
            <%=MyUtil.ObjInput("Tipo de Alfombra", "AlfombraL",AH != null ? AH.getAlfombraL() : "", true, true, 30, iRowPx, "", false, false, 50)%>
        </div>
        
        <div id='divHandyman'>
            <%=MyUtil.ObjInput("Listado", "dsCondicionadoL",AH != null ? AH.getdsCondicionadoL() : "", true, true, 30, iRowPx, "", false, false, 50)%>
            <%=MyUtil.ObjComboC("Ubicacion de falla", "clUbFallaH", AH != null ? AH.getDsUbFallaH() : "", true, true, 550, iRowPx, "", "st_getUbicacionF ", "", "", 50, true, true)%>       
        </div>
        
         <div id='divMedidas'>
            <%=MyUtil.ObjInput("Medidas", "MedidasL",AH != null ? AH.getMedidasL() : "", true, true, 380, iRowPx, "", false, false, 15)%>   
         </div>
