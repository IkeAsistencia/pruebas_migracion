...
<html>
    ...
    <body class="cssBody">
        ...
        %>Fuera de Horario<%
            ...
            /**
             * BETA. Sirve para que el tamaño del doBlock sea automatico XD.
        ...
        <%=MyUtil.ObjInput("Calle y Número", "direccionOrigen", asistenciaTransladoRestos != null ? asistenciaTransladoRestos.getDireccionOrigen() : "", true, true, 30, 160, "", false, false, 106)%>
        ...
        <%=MyUtil.DoBlock("Ubicación del Evento", Valor, 40)%>
        ...
        <%=MyUtil.ObjInput("Calle y Número", "direccionDestino", asistenciaTransladoRestos != null ? asistenciaTransladoRestos.getDireccionDestino() : "", true, true, 30, 580, "", false, false, 106)%>
        ...
        <%=MyUtil.DoBlock("Ubicación de Destino", Valor2, 40)%>
