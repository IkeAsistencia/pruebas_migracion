...
<html>
    ...
    <body class="cssBody" onload="fnValidaStatus();">
        ...
        <% } else { %>
    <center>
        <p style="font-family: Verdana, Arial, Helvetica, sans-serif; color: white; background-color: #1220CD; font-size: 18px;">Área Operativa</p>
        <div style="text-align:center;">
            <table style="alignment-adjust: center">
                <tr style="alignment-adjust: central">
                    ...
                    <td ALIGN="CENTER">
                        <img src="../Imagenes/ServMedico.gif" class="handM" alt='Servicios Médicos'>
                    </td>
                    <td ALIGN="CENTER">
                    ...
                    <td ALIGN="CENTER">
                        <img align="" src="../Imagenes/ServTecnologica.gif" class="handM" alt='Servicios de Tecnológia'>
                    </td>
                    <td ALIGN="CENTER">
                ...
                <tr>
                    ...
                    <td ALIGN="CENTER">
                        <input type="button" class="BgT" onclick="fnSend(5)" value='Médico'>
                    </td>
                    <td ALIGN="CENTER">
                    ...
                    <td ALIGN="CENTER">
                        <input type="button" class="BgT" onclick="fnSend(13)" value='Tecnológica'>
                    </td>
                    <td ALIGN="CENTER">
    ...
    <script>
        function fnValidaStatus() {
            if ((document.all.TieneAsist.value.toString() == "0") && ((document.all.banderaStatus.value == "30") || (document.all.banderaStatus.value == "46"))) {
                var resp = confirm("ESTÁ POR CARGAR UNA ASISTENCIA CON ESTATUS:\n USUARIO NO REQUIERE SERVICIO/FUERA DE COBERTURA.\n DESEA CONTINUAR?");
                if (resp == false) {
