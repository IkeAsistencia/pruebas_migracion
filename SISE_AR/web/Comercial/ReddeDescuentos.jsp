...
<html>
    ...
    <body class="cssBody">
        ...
        <%=MyUtil.ObjInput("Razón Social", "RazonSocial", Red != null ? Red.getRazonSocial() : "", true, true, 40, 170, "", true, true, 50, "")%>
        ...
        <%=MyUtil.ObjInput("Correo Electrónico", "Correo", Red != null ? Red.getCorreo() : "", true, true, 40, 420, "", false, false, 40, "")%>
        <%=MyUtil.ObjInput("Teléfono 1", "Telefono1", Red != null ? Red.getTelefono1() : "", true, true, 40, 460, "", true, true, 25, "")%>
        <%=MyUtil.ObjInput("Teléfono 2", "Telefono2", Red != null ? Red.getTelefono2() : "", true, true, 200, 460, "", false, false, 25, "")%>
