    ...
    <body class="cssBody">
        ...
        <%
            ...
            <% if (rs.next()) {%>
                ...
                <%=MyUtil.ObjInput("Límite Monto", "LimiteMonto", rs.getString("LimiteMonto"), true, true, 30, iRowPx, "", false, false, 10, "EsNumerico(document.all.LimiteMonto)")%>
                <%=MyUtil.ObjInput("Límite Eventos", "LimiteEventos", rs.getString("LimiteEventos"), true, true, 170, iRowPx, "", false, false, 10, "fnRango(document.all.LimiteEventos,0,255)")%>
                <%=MyUtil.ObjInput("Límite Mensual", "LimiteEventosMensual", rs.getString("LimiteEventosMensual"), true, true, 300, iRowPx, "", false, false, 10, "fnRango(document.all.LimiteEventosMensual,0,5)")%>
                ...
                <% if (StrclServicio.equals("3") ) { %>
                    <div id="divHogar" name="divHogar"  style="visibility: 'hidden'">
                        ...
                        <%=MyUtil.ObjInput("Límite Eventos anual", "LimiteEventosAnual", rs.getString("LimiteEventosAnual"), true, true, 170, iRowPx, "", false, false, 10, "fnRango(document.all.LimiteEventosAnual,0,3)")%>
                    </div>
                <% } else { %>
                    <div id="div1000KM"  name="div1000KM" style="visibility: 'hidden'">
                        <%=MyUtil.ObjInput("Límite KM anual", "LimiteMontoAnual", rs.getString("LimiteMontoAnual"), true, true, 30, iRowPx, "", false, false, 10, "EsNumerico(document.all.LimiteMontoAnual)")%>
                        <%=MyUtil.ObjInput("Límite Eventos anual", "LimiteEventosAnual", rs.getString("LimiteEventosAnual"), true, true, 170, iRowPx, "", false, false, 10, "fnRango(document.all.LimiteEventosAnual,0,3)")%>
            ...
            <% } else {%>
                ...
                <% iRowPx = iRowPx + 40; /*200*/%>
                <%=MyUtil.ObjInput("Límite Monto", "LimiteMonto", "", true, true, 30, iRowPx, "", false, false, 10, "EsNumerico(document.all.LimiteMonto)")%>
                <%=MyUtil.ObjInput("Límite Eventos", "LimiteEventos", "", true, true, 170, iRowPx, "", false, false, 10, "fnRango(document.all.LimiteEventos,0,255)")%>
                <%=MyUtil.ObjInput("Límite Mensual", "LimiteEventosMensual", "", true, true, 300, iRowPx, "", false, false, 10, "fnRango(document.all.LimiteEventosMensual,0,5)")%>
                ...
                <% if (StrclServicio.equals("3") ) { %>
                    <div id="divHogar" name="divHogar"  style="visibility: 'hidden'">
                        ...
                        <%=MyUtil.ObjInput("Límite Eventos anual", "LimiteEventosAnual", "", true, true, 170, iRowPx, "", false, false, 10, "fnRango(document.all.LimiteEventosAnual,0,3)")%>
                    </div>
                <% } else {%>
                    <div id="div1000KM" name="div1000KM"  style="visibility: 'hidden'">
                        <%=MyUtil.ObjInput("Límite KM anual", "LimiteMontoAnual", "", true, true, 30, iRowPx, "", false, false, 10, "EsNumerico(document.all.LimiteMontoAnual)")%>
                        <%=MyUtil.ObjInput("Límite Eventos anual", "LimiteEventosAnual", "", true, true, 170, iRowPx, "", false, false, 10, "fnRango(document.all.LimiteEventosAnual,0,3)")%>
...
//------------------------------------------------------------------------------
            function fnEsCoberturaPeajeValida() {
                ...
                if (!esValido) {
                    msgVal = msgVal + ' El monto de cobertura de peaje debe ser un número mayor o igual a 0.';
                }    
                return esValido;
            }
//------------------------------------------------------------------------------            
