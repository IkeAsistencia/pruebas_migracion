...
<html>
    <head>
        <title>Detalle Cobertura del Proveedor Funerario</title>
    ...
    <body class="cssBody" onload="fnValidaCobertura();">
        ...
        %>Fuera de Horario<%
                ...
                String StrclPaginaWeb = "484";

                // se checan permisos de alta,baja,cambio,consulta de esta pagina
                MyUtil.InicializaParametrosC(484, Integer.parseInt(StrclUsrApp));
        %>
        <form id ="formaAsigna" target='VistaPrevia' method='post' action='AsignarCobertura.jsp'>
            ...
            <input id='URLBACK' name='URLBACK' type='hidden' value='<%=request.getRequestURL().substring(0, request.getRequestURL().lastIndexOf("/") + 1)%><%="DetalleCobxProvF.jsp?"%>'>
