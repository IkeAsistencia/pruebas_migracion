...
<html>
    <head>
        <title>Detalle Cobertura del Proveedor Hogar</title>
    ...
    <body class="cssBody" onload="fnValidaCobertura();">
        ...
        %>Fuera de Horario<%
                ...
                String StrclPaginaWeb = "269";

                // se checan permisos de alta,baja,cambio,consulta de esta pagina
                MyUtil.InicializaParametrosC(269, Integer.parseInt(StrclUsrApp));
        %>
        <form id ="formaAsigna" target='VistaPrevia' method='post' action='AsignarCobertura.jsp'>
            ...
            <input id='URLBACK' name='URLBACK' type='hidden' value='<%=request.getRequestURL().substring(0, request.getRequestURL().lastIndexOf("/") + 1)%><%="DetalleCobxProvH.jsp?"%>'>
            ...
            <%=MyUtil.ObjComboCDiv("Provincia", "CodEnt", "", true, false, 200, 165, "", "Select CodEnt, dsEntFed from cEntFed where clPais = 1000", "", "", 25, false, false, "CodEntDiv")%>
