...
<html>
    <head>
        <title>Cobertura de Proveedor Legal</title>
    </head>
    ...
    <%
            ...
            MyUtil.InicializaParametrosC(812, Integer.parseInt(StrclUsrApp));
    %>
    ...
    <frameset framespacing='0' noresize frameborder='no' rows="250,*">
        <frame frameborder='no' noresize name='DetalleCobertura' id='DetalleCobertura' src='DetalleCobxProvL.jsp'></frame>
