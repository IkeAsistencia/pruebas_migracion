...
<html>
    ...
    <body topmargin=470 leftmargin=30 class="cssBody"  >
        ...
        <form action="ListadoCH.jsp" id="Forma1" name="Forma1" target="ListadoCH">
            ...
            <%=MyUtil.ObjInput("<BR>NRO DOCUMENTO", "Documento", "", true, true, 330, 20, "", true, true, 20, "")%> 
            <%=MyUtil.DoBlock("Reporte de Banco Galicia", 100, 30)%>
            <%=MyUtil.GeneraScripts()%>
            <div class='VTable' style='position:absolute; z-index:50; left:490px; top:43px; color: greenyellow'>
...
<!--            <div  class='VTable' style='position:absolute; z-index:4; left:150px; top:73px;'>
        ...
        <script>
            ...
            function fnSolicitaRPTTXT() {
                window.open('ProcesaGalicia.jsp?Bandera=1&FechaIni=' + document.getElementById("FechaInicio").value + "&clPaginaWeb=" + document.getElementById("clPaginaWeb").value
                        + '&FechaFin=' + document.getElementById("FechaFin").value
                        + "&Documento=" + document.getElementById("Documento").value, '', 'resizable=yes,menubar=0,status=1,toolbar=1,screenY=100,height=200,width=400,scrollbars=1');
            }
            function fnSolicitaRPTCSV() {
                window.open('ProcesaGalicia.jsp?Bandera=0&FechaIni=' + document.getElementById("FechaInicio").value + "&clPaginaWeb=" + document.getElementById("clPaginaWeb").value
                        + '&FechaFin=' + document.getElementById("FechaFin").value
                        + "&Documento=" + document.getElementById("Documento").value, '', 'resizable=yes,menubar=0,status=1,toolbar=1,screenY=100,height=200,width=400,scrollbars=1');
            }
        </script>
