...
<html>
    ...
    <body class="cssBody" onload="entra()">
     ...
     if (session.getAttribute("clUsrAppSP")!= null) {
        ...
        StrSql.append("sp_AsignacionMasivaEquipo '").append(StrclUsrAppSP).append("', '").append(StPerifericosElegidos).append("'");
        UtileriasBDF.ejecutaSQLNP(StrSql.toString());
       // System.out.println("Elegidos:  "+  StrSql.toString() );
        StrSql=null;
        %>
        <script> window.opener.fnValidaResponse(1,'ListaAsignacionMasivaSP.jsp?');window.close();
        function entra(){
