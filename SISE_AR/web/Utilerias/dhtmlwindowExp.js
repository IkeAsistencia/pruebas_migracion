...
var FN_WNF = "";
var dhtmlwindow = {
    imagefiles: ['../Imagenes/tab_min.png', '../Imagenes/close.gif', '../Imagenes/tab_max.png', '../Imagenes/resize.gif'], //Path to 4 images used by script, in that order
    ajaxbustcache: false, //Bust caching when fetching a file via Ajax?
//ajaxloadinghtml: '<b>Loading Page. Please wait...</b>', //HTML to show while window fetches Ajax Content?
    ajaxloadinghtml: '', //HTML to show while window fetches Ajax Content?
    minimizeorder: 0,
    zIndexvalue: 100,
    tobjects: [], //object to contain references to dhtml window divs, for scleanup purposes
    ...
    open: function (t, contenttype, contentsource, title, attr, recalonload, lock, fn) {
        this.zIndexvalue = 100;

        this.lock = lock == undefined ? 1 : lock;
