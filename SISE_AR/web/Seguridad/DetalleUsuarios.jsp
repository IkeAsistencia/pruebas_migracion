...
<html>
    ...
    <body class="cssBody" onload='fnValidaPermisos();'>
        ...
        <%=MyUtil.ObjInput("Correo Electrónico", "Correo", usuarios != null ? usuarios.getCorreo(): "", true, true, 700, 190, "", true, true, 65, "validaCorreo();")%>
        ...
        <%=MyUtil.ObjComboC("ÁREA", "clArea", usuarios != null ? usuarios.getDsAreaUsuario() : "", true, true, 220, 235, "", "select clAreaUsuario, dsAreaUsuario from cAreaUsuario order by dsAreaUsuario", "", "", 40, true, true)%>
                ...
                if (document.all.Correo.value != '') {
                    if (document.all.Correo.value.indexOf('@', 0) == -1) {
                        ...
                        if (!dominio.includes("ikeasistencia.com")) {
                            msgVal = msgVal + "La dirección de correo no es valida. Utilice un dominio @ikeasistencia.com.ar o @ikeasistencia.com";
                            document.all.btnGuarda.disabled = false;
                            document.all.btnCancela.disabled = false;
                        }
                    }
            ...
            function validaCorreo() {
                ...
                if (document.all.Correo.value != '') {
                    if (document.all.Correo.value.indexOf('@', 0) == -1) {
                        ...
                        //valida el dominio
                        if (!dominio.includes("ikeasistencia.com")) {
                            alert("La dirección de correo no es valida. Utilice un dominio @ikeasistencia.com.ar o @ikeasistencia.com");                   }
                        }
                    }
                }
//------------------------------------------------------------------------------
