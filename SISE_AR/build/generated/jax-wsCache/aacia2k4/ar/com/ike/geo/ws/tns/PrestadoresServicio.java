...
public class PrestadoresServicio {
    ...
    @XmlElementRef(name = "id_origen", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> idOrigen;
    @XmlElementRef(name = "id_destino", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> idDestino;
    @XmlElementRef(name = "id_caso", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> idCaso;
    @XmlElementRef(name = "id_servicio", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> idServicio;
    @XmlElementRef(name = "id_subservicio", namespace = "tns", type = JAXBElement.class)
