...
/**
 * <p>Clase Java para agregar_servicio complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="agregar_servicio">
 *   &lt;complexContent>
...
@XmlType(name = "agregar_servicio", propOrder = {
    "nombreOrigen",
...
public class AgregarServicio {
    ...
    @XmlElementRef(name = "nombre_origen", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> nombreOrigen;
    @XmlElementRef(name = "codigo_de_autorizacion", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> codigoDeAutorizacion;
    @XmlElementRef(name = "telefono", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> telefono;
    @XmlElementRef(name = "denunciante", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> denunciante;
    @XmlElementRef(name = "cobertura", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> cobertura;
    @XmlElementRef(name = "tipo_srv_inicial", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> tipoSrvInicial;
    @XmlElementRef(name = "desperfecto", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> desperfecto;
    @XmlElementRef(name = "ubicacion", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> ubicacion;
    @XmlElementRef(name = "localidad", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> localidad;
    @XmlElementRef(name = "destino", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> destino;
    @XmlElementRef(name = "origengeo", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> origengeo;
    @XmlElementRef(name = "destinogeo", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> destinogeo;
    @XmlElementRef(name = "patente", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> patente;
    @XmlElementRef(name = "titular", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> titular;
    @XmlElementRef(name = "modelo", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> modelo;
    @XmlElementRef(name = "color", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> color;
    @XmlElementRef(name = "hora_inicio", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> horaInicio;
    @XmlElementRef(name = "operador", namespace = "tns", type = JAXBElement.class)
    protected JAXBElement<String> operador;
    @XmlElementRef(name = "observaciones", namespace = "tns", type = JAXBElement.class)
