    ...
    <body class="cssBody">
        ...
        %>Fuera de Horario<%
            ...
            return;
                ...
                MyUtil.InicializaParametrosC(703,Integer.parseInt(StrclUsrApp));
        %>
        <form name='frmBusq' id='frmBusq' method='post' action='../EstadisticosGNP/RptCaucionesPendientes.jsp'>
        ...
        <%
            if(request.getParameter("clAnio")!= null){
                    ...
                    StrSql.append("st_GNPRptCaucionesPend '").append(StrclAnio).append("','").append(clMes).append("'");
                    StrQry="st_GNPRptCaucionesPend "+StrclAnio+","+clMes;
        ...
        <div style='position:absolute; z-index:20; left:10px; top:120px;'> 
            <font class="STableTitRpt"> <center>Reporte de Cauciones Pendientes<br><br><%=Mes%> - <%=Anio%></center> </font>
            <br>            
