...
<html>
    ...
    <body class="cssBody" >
        ...
        <%=MyUtil.ObjInput("Descripción de la Cuenta", "dsCuenta", CU != null ? CU.getDsCuenta() : "", true, true, 30, 110, "", true, true, 70)%>
        <%=MyUtil.ObjComboC("Canal de Distribución", "clCanalDistribucion", CU != null ? CU.getDsCanalDistribucion() : "", true, true, 415, 110, "", "Select clCanalDistribucion, dsCanalDistribucion from cCanalDistribucion order by dsCanalDistribucion", "", "", 40, true, true)%>
        ...
        <div onmouseover="return overlib('<b>DETERMINA EL CAMPO DE BÚSQUEDA PARA EL AFILIADO.</b>',CENTER);" onmouseout="return nd();">
        ...
        <%=MyUtil.ObjComboC("Tipo de Validación", "clTipoValidacion", CU != null ? CU.getDsTipoValidacion() : "", true, true, 430, 190, "", "Select clTipoValidacion, dsTipoValidacion from cTipoValidacion order by dsTipoValidacion", "", "", 40, true, true)%>
        ...
        <%=MyUtil.ObjInput("Teléfono(1)", "Tel1", CU != null ? CU.getTel1() : "", true, true, 510, 360, "", false, false, 20)%>
        <%=MyUtil.ObjInput("LADA(2)", "Lada2", CU != null ? CU.getLada2() : "", true, true, 450, 400, "", false, false, 6)%>
        <%=MyUtil.ObjInput("Teléfono(2)", "Tel2", CU != null ? CU.getTel2() : "", true, true, 510, 400, "", false, false, 20)%>
        <%=MyUtil.DoBlock("Información de Contacto", 0, 0)%>
