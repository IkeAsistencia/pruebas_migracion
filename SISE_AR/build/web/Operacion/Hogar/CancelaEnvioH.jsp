...
<%  
    ...
    if (session.getAttribute("clExpediente")!= null)
     {
       ...
       StrclPaginaWeb = "765";       
       MyUtil.InicializaParametrosC(765,Integer.parseInt(StrclUsrApp));    // se checan permisos de alta,baja,cambio,consulta de esta pagina
    ...
    if ( request.getParameter("Envio")!= null && request.getParameter("Envio")!= "")        
       {
           ...
           UtileriasBDF.ejecutaSQLNP(" Update EnvioGuiaRojiH Set Estatus = 3, FechaToma = getdate(), clUsrAppToma =" + StrclUsrApp + " Where clEnvio = " + StrEnvio);
        } 
   ...
   // Obteniendo los envíos ya realizados para ese Expediente
    ...
    StrSql.append(" FROM EnvioGuiaRojiH Env INNER JOIN AsigAutProvH AAP ON Env.clEnvio = AAP.clEnvio "); 
  ...
  %>
        <form  id='Forma' name ='Forma' action='CancelaEnvioH.jsp?' method='get'>
