...
<html>
  <head>
    ...
    <title>Actualiza Centro de Comando Piso 4</title>
  </head>
...
function CloseW(){
    ...
    if (gWindowCloseWait>0){
      ...
      top.frames[1].document.location.href="CentrodeComandoP4.jsp?Tipo="+gTipoInfo;
      switch(gTipoInfo){
        case 1 : document.all.LabelMon.innerHTML="Asistencia Vial Carreteros"; gWindowCloseWait = 20; break;
        case 8 : document.all.LabelMon.innerHTML="Asistencia Vial No Carreteros"; gWindowCloseWait = 30; break;    
        default: document.all.LabelMon.innerHTML="Asistencia Vial Carreteros"; gWindowCloseWait = 0; break;
      }
      gTipoInfo++;
