...
<%  
    ...
    StrSql.append(" coalesce(V.MotivoNoLiberacion,'')MotivoNoLib, ");
    ...
    StrSql.append(" where V.clexpediente = ").append(StrclExpediente);
      ...
      StrSql.delete(0,StrSql.length());
       ...
       String StrclPaginaWeb = "582";
       session.setAttribute("clPaginaWebP",StrclPaginaWeb);
       %><SCRIPT>fnOpenLinks()</script><%


       MyUtil.InicializaParametrosC(582,Integer.parseInt(StrclUsrApp)); 
       %>
       ...
       if (rs.next()) {
            ...
            <%=MyUtil.ObjTextArea("Informe de Terminación del Caso","Informe",rs.getString("Informe"),"90","5",true,true,30,450,"",true,true)%>
            <%=MyUtil.ObjInput("*Fecha Terminación","FechaConcluye","",false,false,30,540,"",false,false,19)%>
            <%=MyUtil.DoBlock("Terminación o Continuación del Proceso",70,0)%>            
            ...
            %> El Expediente no Tiene Recuperacion 
