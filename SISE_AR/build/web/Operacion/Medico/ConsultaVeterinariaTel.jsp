...
<html>
    <head><title>Consulta Veterinaria Teléfonica</title>
    ...
    <body class="cssBody">
        ...
        <%
        StrclPaginaWeb = "5001";
        MyUtil.InicializaParametrosC(5001,Integer.parseInt(StrclUsrApp));    // se checan permisos de alta,baja,cambio,consulta de esta pagina
        
        session.setAttribute("clPaginaWebP",StrclPaginaWeb);
        
        %><%=MyUtil.doMenuAct("../../servlet/Utilerias.EjecutaAccionAsist","")%>
        <%="<INPUT id='URLBACK' name='URLBACK' type='hidden' value='"%><%=request.getRequestURL().substring(0,request.getRequestURL().lastIndexOf("/") + 1)%><%="ConsultaVeterinariaTel.jsp?'>"%><%
        ...
        <%=MyUtil.DoBlock("Servicio de Consulta Veterinaria Telefónica",-30,0)%>
