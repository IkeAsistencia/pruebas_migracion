...
<html>
    ...
    <body class="cssBody" onload="fnVerificaFecha();fnLimpiaFechas();">
        ...
        <%=MyUtil.ObjInput("Número de Maletas","Maletas",  conciergeequipaje!=null ? conciergeequipaje.getMaletas() : "",true,true,350,220,"",true,true,10,"EsNumerico(this)")%>
            ...
            function fnValidaFecha(){
                ...
                if (document.all.Fechrecupera.value!='' && document.all.Fechentrega.value!= ''){
                    if (document.all.Fechentrega.value <= document.all.Fechrecupera.value){
                        msgVal = msgVal + " La fecha de entrega debe de ser mayor a la fecha de recuperación. "
                        document.all.btnGuarda.disabled = false;
                        document.all.btnCancela.disabled = false;
                    }
                }
