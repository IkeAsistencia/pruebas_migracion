...
<%
   ...
   if (Integer.parseInt(StrEstatus)==1){
            ...
            StrSql2.append("update CSEventosWow set Activo=1 where clEvento = ").append(StrclEvento);
   ...
   else
       {
            ...
            StrSql2.append("update CSEventosWow set Activo=0 where clEvento = ").append(StrclEvento);
            System.out.println(StrSql2);
            UtileriasBDF.ejecutaSQLNP(StrSql2.toString());
            StrSql2.delete(0,StrSql2.length());
   }
%>
    <script>location.href="CSEventosWow.jsp?clConcierge=<%=StrclConcierge%>"</script>
            <%  
            StrclConcierge=null;
            StrclEvento=null;
%>    
