...
<html>
    ...
    <body class="cssBody">
        ...
        <%=MyUtil.ObjTextArea("Descripción del evento", "DescripcionEvento", SchengenLetter != null ? SchengenLetter.getDescipcion().trim() : "", "83", "3", true, true, 30, 120, "", true, true)%>
        ...
        <%=MyUtil.ObjInput("Número de BIN", "NumeroBin", StrNumeroBin, true, true, 30, 280, StrNumeroBin, true, true, 45)%>
        ...
        <%=MyUtil.ObjComboC("País de destino", "clPais", SchengenLetter != null ? SchengenLetter.getDsPais().trim() : "", true, true, 600, 400, "", "select clPais, rtrim(dsPais) 'dsPais' from cPais where Schengen = 1", "", "", 5, true, true)%>
        <%=MyUtil.DoBlock("Datos del Viaje", 80, 5)%>

        <%=MyUtil.ObjInput("Teléfono", "Telefono", StrTelefono, true, true, 30, 420, StrTelefono, false, false, 30)%>
        ...
        <script>
            ...
            function fnAntesGuardar() {
                ...
                if (document.all.Email.value == '' && document.all.EmailP.value == '' &&
                    ...
                    msgVal = msgVal + " Debe informar por lo menos una dirección de email.";
            ...
            function fnCompruebaEmails() {
                if (document.all.Email.value == '' || document.all.EmailP.value == '' ||
                        ...
                        document.all.EmailAsis.value == '' || document.all.Email2Asis.value == '') {
                    msgVal = msgVal + " Debe informar por lo menos una dirección de email.";
                    //alert('Deve informar pelo menos um endereço de e-mail.');
                }
            }
