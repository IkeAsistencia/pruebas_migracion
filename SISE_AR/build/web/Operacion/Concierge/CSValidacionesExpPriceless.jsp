    ...
    <body class="cssBody">
        ...
        <%
            ...
            if (request.getParameter("clExperiencia") != null) {
                strclExperiencia = request.getParameter("clExperiencia").toString();
            }
            
            System.out.println("sp_GetCSLocalidadesDisp " + strclExperiencia + "," + strclCiudad);
            
            rs = UtileriasBDF.rsSQLNP("sp_GetCSLocalidadesDisp " + strclExperiencia + "," + strclCiudad);
            if (rs.next()) {
