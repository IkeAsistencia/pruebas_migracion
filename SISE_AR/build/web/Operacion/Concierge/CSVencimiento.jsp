...
<%
   String StrVencimiento="0";
           ...
           if (request.getParameter("Vencimiento")!=null)
           {
            ...
            System.out.println(StrVencimiento);
           }
            StringBuffer StrSql = new StringBuffer();
            
            //StrSql.append("set dateformat ymd");
            StrSql.append("set dateformat ymd select case when ISDATE('").append(StrVencimiento).append("') = 1 then (select case when datediff(month,getdate(),'").append(StrVencimiento).append("')< 0 THEN 0 ELSE 1 END) else 0 END 'RESP'");
