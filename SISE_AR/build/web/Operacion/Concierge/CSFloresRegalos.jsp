...
<body class="cssBody" onload="">
    ...
    <%=MyUtil.ObjInput("Teléfono","TelefonoR",conciergeflores!=null ? conciergeflores.getTelefonoR():"",true,true,450,420,"",true,true,25)%>
    ...
    <%=MyUtil.ObjInput("Descripción","Descripcion",conciergeflores!=null ? conciergeflores.getDescripcion():"",true,true,30,525,"",false,false,75)%>
    ...
    <script>
        ...
        if (document.all.Adicionales.value==1){
            if(document.all.Descripcion.value==""){
                msgVal = msgVal + " Debe Ingresar Descripción. ";
