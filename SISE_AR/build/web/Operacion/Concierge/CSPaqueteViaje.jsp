...
<html>
    ...
    <body class="cssBody"  OnLoad="if (document.all.ExpiraVTR.value!=''){fnFechVen(document.all.ExpiraVTR.value)}">
        ...
        <%=MyUtil.ObjInputF("Tiempo Límite <Strong>(AAAA-MM-DD hh:mm)</Strong>", "TiempoLimite", PV != null ? PV.getTiempoLimite() : "", true, true, 460,545,"", false, false,20,2,"")%>
        ...
        <%=MyUtil.ObjInput("Pol.Cancelación", "Cancelacion", PV != null ? PV.getCancelacion() : "", true, true, 30, 1000, "", false, false, 50)%>
