...
<html>
    ...
    <body class="cssBody" onload="fnVerificaFecha();fnLimpiaFechas();">
        ...
        <div class='VTable' style='position:absolute; z-index:25; left:400px; top:15px;'><p align="center"><font color="navy" face="Arial" size="3" ><b><i> Reservacion de Transportación (Ejecutiva / Convencional)</i></b>  <br> </p></div>
        ...
        <%=MyUtil.ObjChkBox("Niños","Ninos",conciergetransp!=null ? conciergetransp.getNinos().trim():"",true,true,130,220,"","SI","NO","EdadesNinos()")%>
        ...
        <%=MyUtil.DoBlock("Reservacion de Transportación (Ejecutiva / Convencional)",100,5)%>
        ...
        <%=MyUtil.ObjInput("Pol.Cancelación","PCancel",conciergetransp!=null ? conciergetransp.getPCancel().trim():"",true,true,30,750,"",false,false,50)%>
