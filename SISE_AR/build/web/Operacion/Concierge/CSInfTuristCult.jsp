...
<html>
<head><title>InformaciónTurísticas / Cultural</title>
...
<body class="cssBody" onload="fnVerificaFecha();fnLimpiaFechas();">
    ...
    <div class='VTable' style='position:absolute; z-index:25; left:400px; top:15px;'><p align="center"><font color="navy" face="Arial" size="3" ><b><i> Información Turística / Cultural </i></b>  <br> </p></div>
    <script src='../../Utilerias/UtilCalendario.js'></script>
    <link href="../../StyleClasses/Calendario.css" rel="stylesheet" type="text/css">
    <script src='../../Utilerias/UtilStore.js'></script>
    
    <div class='VTable' style='position:absolute; z-index:25; left:570px; top:93px;'><p align="center"><font color="navy" face="Arial" size="2" ><b><i>Automática </i></b>  <br> </p></div>
    <%
    ...
    <%=MyUtil.ObjTextArea("Descripción De evento","DescripcionEvento",ConciergeInfTC!=null ? ConciergeInfTC.getDescripcionEvento().trim():  "","83","3",true,true,30,120,"",true,true)%>
    ...
    <%=MyUtil.ObjInputF("Início de actividades <Strong>(AAAA-MM-DD)</Strong>","FechaInicio",ConciergeInfTC!=null ? ConciergeInfTC.getFechaInicio().trim():"",true,true,30,220,"",false,false,20, 2, "")%>
    ...
    <%=MyUtil.ObjChkBox("Niños","Menores",ConciergeInfTC!=null ? ConciergeInfTC.getMenores().trim():"",true,true,600,220,"","SI","NO","EdadesNinos()")%>
    ...
    <%=MyUtil.ObjChkBox("Costumbres / Información local","InfLocal",ConciergeInfTC!=null ? ConciergeInfTC.getInfLocal().trim():"",true,true,30,400,"","SI","NO","")%>
    ...
    <%=MyUtil.ObjInput("Descripción","DescripOtros",ConciergeInfTC!=null ? ConciergeInfTC.getDescripOtros().trim():"",true,true,700,400,"",false,false,30)%>
    ...
    <%=MyUtil.ObjInput("Pol.Cancelación","PCancel",ConciergeInfTC!=null ? ConciergeInfTC.getPCancel().trim():"",true,true,30,760,"",false,false,50)%>
        ...
        function fnAdicional(){
            if (document.all.Menores.value==1){
                if(document.all.DescripMenores.value==""){
                    msgVal = msgVal + " Deve ingresar Descripción (Idades). ";
                    document.all.btnGuarda.disabled=false;
                    document.all.btnCancela.disabled=false;
                }
            }
