...
<html>
    <head>
        <title>Detalle de Solicitud Help Desk Soporte</title>
    ...
    <body class="cssBody" onload="">
        ...
        <div class='VTable' style='position:absolute; z-index:25; left:400px; top:15px;'><p align="center"><font color="navy" face="Arial" size="3" ><b><i>Solicitud de Servicio Help Desk Soporte Tecnico</i></b></font><br></p></div>
        ...
        <%=MyUtil.doMenuAct("../servlet/com.ike.guarda.EjecutaSP", "", "fnCamposObligatorios();fnsp_Guarda();")%>
        <%
                if (HD != null) {
        ...
        <%=MyUtil.ObjInput("CORREO (USUARIO SOLICITA)", "Correo", HD != null ? HD.getCorreo() : "", false, false, 330, 200, "", false, false, 40, "validaCorreo();")%>
        ...
        <DIV ID='nacho'>
            <%=MyUtil.ObjComboC("Colaborador", "clColaboradorAsignadoSP", HD != null ? HD.getdsColaboradorAsignadoSP() : "", true, true, 20, 620, "", "select clColaboradorAsignadoSP,dsColaboradorAsignadoSP from cColaboradorAsignadoSP where Activo=1 order by (2)", "", "", 30, false, false)%>
