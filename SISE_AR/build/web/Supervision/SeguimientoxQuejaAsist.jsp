...
<html>
    ...
    <body class="cssBody">
        ...
        StrSql.append("st_SCSgetdetQuejaxAsist ").append(StrclSeguimientoQueja);
        ...
        MyUtil.InicializaParametrosC(6117,Integer.parseInt(StrclUsrApp));
        session.setAttribute("clPaginaWebP",StrclPaginaWeb);%> 
        
        <%=MyUtil.doMenuAct("../servlet/Utilerias.EjecutaAccion","")%>
        <INPUT id='URLBACK' name='URLBACK' type='hidden' value='<%=request.getRequestURL().substring(0,request.getRequestURL().lastIndexOf("/") + 1) + "SeguimientoxQuejaAsist.jsp?"%>'>
        ...
        <%
            ...
            StrSql.append("st_SCSgetDetQuejaxSupAsist ").append(StrclQuejaxSupervision);
        ...
        <% }else{%>
        <script>document.all.btnAlta.disabled=true;document.all.btnCambio.disabled=true;</script>
        ...
        if (StrclSeguimientoQueja.equalsIgnoreCase("0")){ %>
        <script>
