...
<html>
    <head>
        <title>Detalle Cobertura del Proveedor Viajes</title>
    ...
    <body class="cssBody" onload="fnValidaCobertura();">
        ...
        %>Fuera de Horario<%
                ...
                String StrclPaginaWeb = "356";

                // se checan permisos de alta,baja,cambio,consulta de esta pagina
                MyUtil.InicializaParametrosC(356, Integer.parseInt(StrclUsrApp));
        %>
        <form id ="formaAsigna" target='VistaPrevia' method='post' action='AsignarCobertura.jsp'>
            ...
            <input id='URLBACK' name='URLBACK' type='hidden' value='<%=request.getRequestURL().substring(0, request.getRequestURL().lastIndexOf("/") + 1)%><%="DetalleCobxProvV.jsp?"%>'>
