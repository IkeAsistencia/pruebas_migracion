...
<html>
    <head>
        <title>Cobertura de Proveedor Ambulancia</title>
    </head>
    ...
    <%
            ...
            MyUtil.InicializaParametrosC(815, Integer.parseInt(StrclUsrApp));
    %>
    ...
    <frameset framespacing='0' noresize frameborder='no' rows="250,*">
        <frame frameborder='no' noresize name='DetalleCobertura' id='DetalleCobertura' src='DetalleCobxProvA.jsp'></frame>
