...
<html>
    ...
    <body class="cssBody">
        ...
        String StrclPaginaWeb = "362";
        session.setAttribute("clPaginaWebP",StrclPaginaWeb);
        %><SCRIPT>fnOpenLinks()</script><%
        
        MyUtil.InicializaParametrosC(362,Integer.parseInt(StrclUsrApp)); 
        %><%=MyUtil.doMenuAct("../servlet/Utilerias.EjecutaAccion","","")%>
        <%="<INPUT id='URLBACK' name='URLBACK' type='hidden' value='"%><%=request.getRequestURL().substring(0,request.getRequestURL().lastIndexOf("/") + 1)%><%="DetalleSubservxProvA.jsp?'>"%>
        ...
        <%=MyUtil.ObjInput("Prioridad","Prioridad",sub != null ? sub.getPrioridad() : "",true,true,420,100,"",true,true,5,"fnActualizaVal();")%>    
        ...
        <%=MyUtil.DoBlock("Detalle de Subservicio por Proveedor Ambulancia",0,30)%>
