...
<html>
    ...
    <body class="cssBody">
        ...
        <%          ResultSet rs = UtileriasBDF.rsSQLNP(StrSql.toString());
            ...
            MyUtil.InicializaParametrosC(162, Integer.parseInt(strclUsr));
        %>
        ...
        <%=MyUtil.ObjComboC("Tipo solucion", "clTipoSolucion", rs.getString("dsTipoSolucion"), true, true, 30, 140, "", "select 0 'clConcepto', 'OTRO' 'dsConcepto' union select clConcepto,dsConcepto from cConceptoCosto where clAreaOperativa = 4 and activo=1 order by dsConcepto", "", "fnHabilitaSolucion()", 50, true, true)%>
        ...
        <%=MyUtil.ObjComboC("Tipo solucion", "clTipoSolucion", "", true, true, 30, 140, "", "select 0 'clConcepto', 'OTRO' 'dsConcepto' union select clConcepto,dsConcepto from cConceptoCosto where clAreaOperativa = 4 and activo=1 order by dsConcepto", "", "fnHabilitaSolucion()", 50, true, true)%>
        ...
        <%
            ...
            if (StrclSubservicio.equalsIgnoreCase("222")) {
        %>
        <%=CamposExtra.strGetCamposExtraHTML(MyUtil, strclCuenta, StrclSubservicio, session, 30, 575, rs).toString()%>  
        <%=MyUtil.DoBlock("Campos Extra de la Cuenta", 10, 0)%>
        <%
            }
