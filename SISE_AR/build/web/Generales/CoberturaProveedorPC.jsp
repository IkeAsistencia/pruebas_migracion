...
<html>
    <head>
        <title>Cobertura de Proveedor Asistencia PC</title>
    </head>
    ...
    <%
            ...
            MyUtil.InicializaParametrosC(817, Integer.parseInt(StrclUsrApp));
    %>
    ...
    <frameset framespacing='0' noresize frameborder='no' rows="250,*">
        <frame frameborder='no' noresize name='DetalleCobertura' id='DetalleCobertura' src='DetalleCobxProvPC.jsp'></frame>
