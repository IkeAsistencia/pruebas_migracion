...
<html>
<head>        
    <title>DetalleSeguimientoProveedorR</title>
</head>
...
<body class="cssBody" onload="">
    ...
    <%MyUtil.InicializaParametrosC(801,Integer.parseInt(StrclUsr));
    %>
    <%=MyUtil.doMenuAct("../servlet/Utilerias.EjecutaAccion","")%>
    
    <INPUT id='URLBACK' name='URLBACK' type='hidden' value='<%=request.getRequestURL().substring(0,request.getRequestURL().lastIndexOf("/") + 1)%><%="SeguimientoProveedorR.jsp?"%>'>
    <%
    int iY = 40;
    %>          
