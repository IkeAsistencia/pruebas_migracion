...
<html>
    <head>
        <title>Cobertura de Proveedor Viajes</title>
    </head>
    ...
    <%
            ...
            MyUtil.InicializaParametrosC(813, Integer.parseInt(StrclUsrApp));
    %>
    ...
    <frameset framespacing='0' noresize frameborder='no' rows="250,*">
        <frame frameborder='no' noresize name='DetalleCobertura' id='DetalleCobertura' src='DetalleCobxProvV.jsp'></frame>
