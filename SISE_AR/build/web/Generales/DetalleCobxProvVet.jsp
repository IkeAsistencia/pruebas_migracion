...
<html>
    ...
    <body class="cssBody" onload="fnValidaCobertura();">
        ...
        %>Fuera de Horario<%
                ...
                String StrclPaginaWeb = "5009";

                // se checan permisos de alta,baja,cambio,consulta de esta pagina
                MyUtil.InicializaParametrosC(5009, Integer.parseInt(StrclUsrApp));
        %>
        <form id ="formaAsigna" target='VistaPrevia' method='post' action='AsignarCobertura.jsp'>
            ...
            <input id='URLBACK' name='URLBACK' type='hidden' value='<%=request.getRequestURL().substring(0, request.getRequestURL().lastIndexOf("/") + 1)%><%="DetalleCobxProvVet.jsp?"%>'>
