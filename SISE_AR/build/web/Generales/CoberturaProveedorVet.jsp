...
<html>
    <head>
        <title>Cobertura de Proveedor Veterinario</title>
    </head>
    ...
    <%
            ...
            MyUtil.InicializaParametrosC(5010, Integer.parseInt(StrclUsrApp));
    %>
    ...
    <frameset framespacing='0' noresize frameborder='no' rows="250,*">
        <frame frameborder='no' noresize name='DetalleCobertura' id='DetalleCobertura' src='DetalleCobxProvVet.jsp'></frame>
